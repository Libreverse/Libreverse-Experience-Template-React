...
export const HotKeysProvider: React.FC<{ children: React.ReactNode }> = ({
  ...
  const handleKeyDown = useCallback((e: KeyboardEvent) => {
    ...
    switch (e.key.toLowerCase()) {
      case "w":
        setKeys((k) => (k.w ? k : { ...k, w: true }));
        break;
      case "a":
        setKeys((k) => (k.a ? k : { ...k, a: true }));
        break;
      case "s":
        setKeys((k) => (k.s ? k : { ...k, s: true }));
        break;
      case "d":
        setKeys((k) => (k.d ? k : { ...k, d: true }));
        break;
      case " ":
      case "space":
        setKeys((k) => (k.space ? k : { ...k, space: true }));
        break;
    }
  }, []);
  ...
  const handleKeyUp = useCallback((e: KeyboardEvent) => {
    switch (e.key.toLowerCase()) {
      case "w":
        setKeys((k) => (k.w ? { ...k, w: false } : k));
        break;
      case "a":
        setKeys((k) => (k.a ? { ...k, a: false } : k));
        break;
      case "s":
        setKeys((k) => (k.s ? { ...k, s: false } : k));
        break;
      case "d":
        setKeys((k) => (k.d ? { ...k, d: false } : k));
        break;
      case " ":
      case "space":
        setKeys((k) => (k.space ? { ...k, space: false } : k));
        break;
    }
  }, []);
